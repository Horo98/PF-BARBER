        ...
        return (
            <div >
                <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
                    ...
                    <Navbar.Brand>
                                <Link to="/">
                 <img  height="80px" src="https://media.discordapp.net/attachments/1026470124292681745/1041495702204850247/hola2.png?width=590&height=590" alt="Olea" />
                 </Link>
                 </Navbar.Brand>
...
</svg></Link></div> : "" + " 👋" : "Welcome to Barbers Shop!"}</span>
